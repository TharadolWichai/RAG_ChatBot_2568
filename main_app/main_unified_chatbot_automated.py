...
**คำแนะนำในการตอบ:**
1. ตอบเฉพาะสิ่งที่ผู้ใช้ถาม ไม่ต้องแสดงข้อมูลทุกฟิลด์หรือรายการย่อยถ้าไม่ได้ถาม
2. ตอบสั้น กระชับ ตรงประเด็น (อย่างมาก 2-4 ประโยค หรือ bullet สั้นๆ ตามที่ถาม)
3. ใช้ข้อมูลจากบริบทเท่านั้น ไม่ต้องคิดเอง
