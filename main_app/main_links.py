...
class LinksRetriever(BaseRetriever):
    ...
    def _get_comprehensive_search(self) -> List[Document]:
        ...
        try:
            ...
            results = self.collection.find({"metadata.category": "links"}, limit=50)  # Get up to 50 links
    ...
    def _ensure_bm25_initialized(self):
        ...
        if self.bm25_retriever is None:
            ...
            try:
                ...
                results = self.collection.find({"metadata.category": "links"}, limit=100)
                documents = []
    ...
    def _advanced_thai_search(self, query: str) -> List[Document]:
        ...
        try:
            ...
            all_results = list(self.collection.find({"metadata.category": "links"}, limit=100))
            matched_docs = []
    ...
    def _fallback_keyword_search(self, query: str) -> List[Document]:
        ...
        try:
            ...
            results = self.collection.find({"metadata.category": "links"}, limit=50)
    ...
    if openrouter_api_key:
        try:
            llm = ChatOpenAI(
                ...
                default_headers={"HTTP-Referer": "https://github.com/your-repo", "X-Title": "Links RAG Chatbot"}
            )
