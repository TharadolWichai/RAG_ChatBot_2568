...
# ✅ สร้าง Prompt - ปรับปรุงเพื่อให้เหมาะกับข้อมูลอาจารย์ (ตอบสั้น ตรงสิ่งที่ถาม)
PROMPT = PromptTemplate.from_template("""
บริบทต่อไปนี้คือข้อมูลเกี่ยวกับอาจารย์ในคณะวิทยาลัยการคอมพิวเตอร์ มหาวิทยาลัยขอนแก่น

**คำแนะนำ:**
- ตอบเฉพาะสิ่งที่ผู้ใช้ถามเท่านั้น (เช่น ถ้าถามแค่อีเมล ให้ตอบแค่อีเมล ไม่ต้องแสดงชื่อ ตำแหน่ง เบอร์โทร slug)
- ตอบสั้น กระชับ ตรงประเด็น
- หากถามรายชื่อหลายคน ค่อยแสดงเป็นรายการสั้นๆ
...
---------------------
คำถาม: {question}
คำตอบ (สั้น กระชับ ตรงสิ่งที่ถาม):
""")
